...
function TradeBot() {
    ...
    <h2>!!! ÖNEMLİ UYARI: TradeBot'un amacı yaptığınız analizleri bilimsel olarak karşılaştırmaktır, bir YATIRIM TAVSİYESİ DEĞİLDİR. Kendi finanasal okur-yazarlığınız ile piyasaları ve şartları değerlendirip kendi kararınız ile yatırım yapmalısınız.</h2>
     </Container>
